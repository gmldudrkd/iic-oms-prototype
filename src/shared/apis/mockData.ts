...
const mockOrderList = {
  data: [
    ...
    },
    {
      ...
      receiveMethod: "Delivery",
      orderedAt: yesterday,
      ordererEmail: "sophia.lee@example.com",
      ordererName: "Sophia Lee",
      ordererPhone: "+1-555-0109",
      originOrderNo: "GM-2025020109",
      purchaseNo: "PUR-009",
      recipientName: "Sophia Lee",
      recipientPhone: "+1-555-0109",
      shipments: [
        {
          shipmentId: "SHP-009",
          shipmentNo: "SHIP-20250201-009",
          status: { name: "SHIPPED", description: "Shipped" },
          trackingNo: "1Z999AA10123456709",
        },
      ],
      status: { name: "COMPLETED", description: "Completed" },
    },
    {
      ...
      receiveMethod: "Delivery",
      orderedAt: yesterday,
      ordererEmail: "daniel.cho@example.com",
      ordererName: "Daniel Cho",
      ordererPhone: "+1-555-0110",
      originOrderNo: "GM-2025020110",
      purchaseNo: "PUR-010",
      recipientName: "Daniel Cho",
      recipientPhone: "+1-555-0110",
      shipments: [
        {
          shipmentId: "SHP-010",
          shipmentNo: "SHIP-20250201-010",
          status: { name: "SHIPPED", description: "Shipped" },
          trackingNo: "1Z999AA10123456710",
        },
      ],
      status: { name: "COMPLETED", description: "Completed" },
    },
...
const mockOrderDetail = {
  ...
  items: [
    ...
    },
    {
      ...
      sku: "S11003424",
      productCode: "11003424",
      productName: "BENVEN-GR7",
      upcCode: "8809123456002",
      thumbnailUrl: "",
      sequence: 2,
      orderedQuantity: 1,
      ...
      components: [
        {
          sku: "S14000219",
          productCode: "14000219",
          productName: "167-TINT",
          category: "Eyewear",
          price: 70000,
          quantity: 1,
          shipmentQuantity: 1,
    ...
    {
      orderItemId: "OI-003",
      originItemId: "ORIG-003",
      sku: "S11003422",
      productCode: "11003422",
      productName: "GM Sunglasses",
      upcCode: "8809123456003",
      thumbnailUrl: "",
      sequence: 3,
      orderedQuantity: 1,
    ...
    {
      orderItemId: "OI-004",
      originItemId: "ORIG-004",
      sku: "S11005159",
      productCode: "11005159",
      productName: "VERT-02",
      upcCode: "8809123456004",
      thumbnailUrl: "",
      sequence: 4,
      ...
      components: [
        {
          sku: "S11500904",
          productCode: "11500904",
          productName: "2026 PACKAGE SET(POCKET-W)",
          category: "Packaging",
          price: 0,
          quantity: 1,
          shipmentQuantity: 1,
    ...
    {
      orderItemId: "OI-005",
      originItemId: "ORIG-005",
      sku: "S16000271",
      productCode: "16000271",
      productName: "2026 VEGGIE KEYCHAIN",
      upcCode: "8809123456005",
      thumbnailUrl: "",
      sequence: 5,
      orderedQuantity: 1,
  ...
  payments: [
    {
      ...
      taxAmount: 0,
      dutyAmount: 0,
      transactionNo: "TXN-20250201-009",
    },
  ],
  shipments: [
    {
      ...
      deliveries: [
        {
          trackingNo: "1Z999AA10123456709",
          trackingUrl: "https://www.ups.com/track?tracknum=1Z999AA10123456709",
        },
      ],
      items: [
        {
...
// --- 기프트카드를 구매한 주문 상세 (Purchased a Gift Card) ---
  ...
  items: [
    {
      ...
      originItemId: "ORIG-001",
      sku: "40000022",
      productCode: "40000022",
      productName: "2025 GIFT CARD KR 30",
      // 기프트카드 시리얼번호 (Ordered Product Info에서 상품명 아래 노출)
      giftCardSerial: "F9D1-06DH-RYAV",
      upcCode: "",
      thumbnailUrl: "",
      sequence: 1,
  ...
  payments: [
    {
      ...
      taxAmount: 0,
      dutyAmount: 0,
      transactionNo: "TXN-20250201-010",
    },
  ],
  shipments: [
    {
      ...
      deliveries: [
        {
          trackingNo: "1Z999AA10123456710",
          trackingUrl: "https://www.ups.com/track?tracknum=1Z999AA10123456710",
        },
      ],
      items: [
        {
...
const mockReturnDetail = [
  ...
  },
  {
    ...
    returnMethod: "Return with Pickup",
    claimRequesterType: "CUSTOMER",
  ...
  },
  {
    ...
    delivery: {
      carrierCode: "CANADA_POST",
      trackingNo: "1Z999AA10123456793",
      deliveryType: "RETURN",
    },
    trackingUrl:
      "https://www.canadapost-postescanada.ca/track-reperer/en#/details/1Z999AA10123456793",
    items: [
      {
        productCode: "SAP-GM-001",
        productName: "Jennie - Kuku 01",
  ...
  {
    returnId: "RTN-008",
    returnNo: "RTN-NO-20250201-008",
    claimId: "CLM-RTN-008",
    orderId: "ORD-20250201-005",
    originOrderNo: "GM-2025020105",
    status: { name: "PICKUP_ONGOING", description: "Pickup Ongoing" },
    claimFault: "CUSTOMER",
    claimReason: "Changed mind",
    returnMethod: "Parcel",
    claimRequesterType: "CUSTOMER",
    claimCreatedBy: "mike.park@example.com",
    createdAt: twoDaysAgo,
    ...
    delivery: {
      carrierCode: "CANADA_POST",
      trackingNo: "1Z999AA10123456799",
      deliveryType: "RETURN",
    },
    trackingUrl:
      "https://www.canadapost-postescanada.ca/track-reperer/en#/details/1Z999AA10123456799",
    items: [
      {
        productCode: "SAP-GM-002",
        productName: "Jennie - Kuku 02",
        ...
        products: [
          {
            sku: "GM-KUK-002-WHT",
            productCode: "SAP-GM-002",
            productName: "Jennie - Kuku 02 White",
            category: "Eyewear",
            price: 320,
            quantity: 1,
          },
  ...
  },
  {
    ...
    status: { name: "REFUNDED", description: "Refunded" },
    claimFault: "OPERATION",
    claimReason: "Wrong item received",
    returnMethod: "Force Refund without Pickup",
    claimRequesterType: "OMS_ADMIN",
    claimCreatedBy: "ops.admin@example.com",
    createdAt: threeDaysAgo,
    updatedAt: now,
    recipient: {
      fullName: "David Wang",
...
const ORDER_LOG_NO = "AT26060100DMT0BYWN";
const SHIPMENT_LOG_NO = "SH849086347827338973";

const mockOrderHistory = {
  orderHistories: [
    // 주문 단위 상태 (Pending → Collected → Shipment Requested)
    {
      orderId: "ORD-20250201-001",
      originOrderNo: ORDER_LOG_NO,
      sequence: 1,
      status: { name: "PENDING", description: "Pending" },
      event: { name: "ORDER_RECEIVED", description: "Order Received" },
      updatedAt: "2026-06-01T09:40:03Z",
      sapResults: [],
    },
    {
      orderId: "ORD-20250201-001",
      ...
      sequence: 2,
      status: { name: "COLLECTED", description: "Collected" },
      event: { name: "PAYMENT_COLLECTED", description: "Payment Collected" },
      updatedAt: "2026-06-01T09:46:00Z",
      sapResults: [],
    },
    {
      orderId: "ORD-20250201-001",
    ...
    },
    {
      ...
      updatedAt: "2026-06-01T09:46:00Z",
      sapResults: [
        { result: "019 / Success", resultAt: "2026-06-01T09:46:00Z" },
      ],
    },
    // 배송 단위 상태 (Picking Requested → Picked → Packed → Shipped → Delivered)
    {
      orderId: "ORD-20250201-001",
      originOrderNo: ORDER_LOG_NO,
      sequence: 1,
      status: { name: "COLLECTED", description: "Collected" },
      shipmentId: "SHP-001",
      shipmentNo: SHIPMENT_LOG_NO,
      shipmentStatus: {
        name: "PICKING_REQUESTED",
        description: "Picking Requested",
      },
      event: { name: "PICKING_REQUESTED", description: "Picking Requested" },
      updatedAt: "2026-06-01T09:46:00Z",
      sapResults: [],
    },
    {
      ...
      event: { name: "PICKING_REQUESTED", description: "Picking Requested" },
      updatedAt: "2026-06-01T09:46:01Z",
      sapResults: [],
    },
    {
      orderId: "ORD-20250201-001",
      ...
      shipmentId: "SHP-001",
      shipmentNo: SHIPMENT_LOG_NO,
      shipmentStatus: { name: "PICKED", description: "Picked" },
      event: { name: "PICKED", description: "Picked" },
      updatedAt: "2026-06-01T10:49:16Z",
      sapResults: [],
    },
    {
      orderId: "ORD-20250201-001",
      ...
      shipmentId: "SHP-001",
      shipmentNo: SHIPMENT_LOG_NO,
      shipmentStatus: { name: "PACKED", description: "Packed" },
      event: { name: "PACKED", description: "Packed" },
      updatedAt: "2026-06-01T10:49:19Z",
      sapResults: [],
    },
    {
      orderId: "ORD-20250201-001",
      ...
      event: { name: "SHIPPED", description: "Shipped" },
      updatedAt: "2026-06-01T10:49:29Z",
      sapResults: [
        { result: "020 / Success", resultAt: "2026-06-01T10:49:29Z" },
      ],
    },
    {
      orderId: "ORD-20250201-001",
      ...
      shipmentId: "SHP-001",
      shipmentNo: SHIPMENT_LOG_NO,
      shipmentStatus: { name: "DELIVERED", description: "Delivered" },
      event: { name: "DELIVERED", description: "Delivered" },
      updatedAt: "2026-06-05T14:19:57Z",
      sapResults: [
        { result: "020_1 / Success", resultAt: "2026-06-05T14:19:58Z" },
      ],
    },
    // 주문 완료
    {
      ...
      sequence: 5,
      status: { name: "COMPLETED", description: "Completed" },
      event: { name: "ORDER_COMPLETED", description: "Order Completed" },
      updatedAt: "2026-06-05T14:19:57Z",
      sapResults: [],
    },
  ],
  returnHistories: [
    {
      returnId: "RTN-001",
      returnNo: "RT850202572143697911",
      sequence: 1,
      status: { name: "PENDING", description: "Pending" },
      updatedAt: "2026-06-04T11:41:29Z",
      sapResults: [],
    },
    {
      returnId: "RTN-002",
      ...
      sequence: 2,
      status: { name: "PENDING", description: "Pending" },
      updatedAt: "2026-06-05T14:07:17Z",
      sapResults: [],
    },
    {
      returnId: "RTN-002",
...
export function getMockResponse(url: string, method: string = "GET"): unknown {
  ...
  if (path.match(/\/orders\/[^/]+$/)) {
    ...
    // 기프트카드 결제/구매 주문은 전용 상세 데이터 반환
    if (orderId?.toLowerCase() === "ord-20250201-009")
