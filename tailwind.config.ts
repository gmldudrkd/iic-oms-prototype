const config: {
  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        shipment: "var(--color-shipment)",
        "shipment-opacity": "var(--color-shipment-opacity)",
        storePickup: "var(--color-storePickup)",
        "storePickup-opacity": "var(--color-storePickup-opacity)",
        reshipment: "var(--color-reshipment)",
        "reshipment-opacity": "var(--color-reshipment-opacity)",
  ...
  safelist: [
    ...
    "border-b-exchange",
    "border-b-shipment",
    "border-b-storePickup",
    "border-b-reshipment",
    "bg-order-opacity",
    "bg-return-opacity",
    "bg-exchange-opacity",
    "bg-shipment-opacity",
    "bg-storePickup-opacity",
    "bg-reshipment-opacity",
    "text-order",
    "text-return",
    "text-exchange",
    "text-shipment",
